"""Стратегия прекращения игры сообщает боту, когда ему следует остановиться"""
...
"""Пропуск хода в ответ на пропуск хода противника"""
def get(termination):
...
class TerminationAgent(Agent):
    """Снабжение агента стратегией завершения игры"""
